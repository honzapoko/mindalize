...
export default function ConfirmedPage() {
  return (
    <div className="tarot-container" style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div className="tarot-results" style={{ maxWidth: 480, width: '100%', margin: '0 auto', background: '#fff', borderRadius: 16, boxShadow: '0 4px 24px rgba(49,46,129,0.08)', padding: 32, textAlign: 'center' }}>
        <h1 style={{ color: '#312e81', marginBottom: 16 }}>E-mail potvrzen!</h1>
        <p style={{ marginBottom: 24 }}>
          Děkujeme za potvrzení vaší e-mailové adresy.<br />
          Nyní můžete využívat všechny funkce aplikace.
        </p>
        <h2 style={{ color: '#312e81', marginBottom: 12 }}>Co získáte s prémiovým členstvím?</h2>
        ...
        <form action="/api/create-checkout-session" method="POST">
          <button type="submit" className="button-primary" style={{ marginTop: 16, marginBottom: 16, padding: '0.7rem 1.5rem', borderRadius: 8, background: '#312e81', color: '#fff', fontWeight: 600, fontSize: '1rem', border: 'none', cursor: 'pointer' }}>
